CREATE DATABASE  IF NOT EXISTS `cineflix` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cineflix`;
...
INSERT INTO `assinante` VALUES (1,'João Silva','joao@email.com','123','Ativo',3),(2,'Maria Souza','maria@email.com','abc','Ativo',1),(3,'Carlos Lima','carlos@email.com','xyz','Pendente',2);
...
INSERT INTO `genero` VALUES (1,'Ação'),(2,'Comédia'),(3,'Ficção Científica'),(4,'Drama'),(5,'Terror');
...
INSERT INTO `historico_visualizacao` VALUES (1,'2025-11-20 20:00:00',120,120,1,1),(2,'2025-11-21 15:30:00',15,15,2,2);
...
INSERT INTO `perfil` VALUES (1,'João Pai','Adulto',1),(2,'Joãozinho','Kids',1),(3,'Maria','Adulto',2);
...
INSERT INTO `plano` VALUES (1,'Básico com Anúncios',19.90),(2,'Padrão HD',39.90),(3,'Premium 4K',59.90);
...
INSERT INTO `titulo` VALUES (1,'O Predador de Marte','Astronautas lutam em Marte.',2024,120,'+14'),(2,'Aventura na Cidade','Um cachorro perdido em SP.',2023,95,'Livre'),(3,'O Lago Secreto','Mistérios em um acampamento.',2022,110,'+16');
...
INSERT INTO `titulo_genero` VALUES (1,1),(2,2),(1,3),(3,4),(3,5);
...
-- Dump completed on 2025-11-22 14:49:24
